...
<!-- Mirrored from imedica.sharkslab.com/HTML/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Feb 2016 20:00:10 GMT -->
<head>
            ...
            <div class="header-bg">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
                            <li class="active"><a href="index.jsp" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-home"></i>Home</a>
								
							</li>

                            <li class="dropdown"><a href="signup.jsp" ><i class="icon-cog"></i>Find Doctors<b class="icon-angle-down"></b></a>
                                
                            </li>
                            <li class="dropdown"><a href="signup.jsp" ><i class="icon-cog"></i>All Doctors<b class="icon-angle-down"></b></a>
                                
                            </li>
                            <li class="dropdown"><a href="signup.jsp" ><i class="icon-cog"></i>Area Vise<b class="icon-angle-down"></b></a>
                            ...
                            <li class="dropdown"><a href="signup.jsp" ><i class="icon-cog"></i>About us<b class="icon-angle-down"></b></a>
            ...
            <!-- THE BOXSLIDE EFFECT EXAMPLES  WITH LINK ON THE MAIN SLIDE EXAMPLE -->
              ...
              <li data-transition="papercut" data-slotamount="7">
                    ...
                    <div class="tp-caption whitebg-t1 sfr skewtoright imed-sl1"
                        ...
                        data-endspeed="400"
                        data-endeasing="Power1.easeIn"
                        >Easyly Find Doctor Through<br>Area or Speciality..
                    </div>
                    ...
                    <div class="tp-caption whitebg-t2 sfr skewtoright imed-sl1"
                        ...
                        data-endspeed="400"
                        data-endeasing="Power1.easeIn"
                        >Experiance to simple find doctors..
                    </div>
                    ...
                    <!-- LAYER NR. 9 -->
                     ...
                     <div class="tp-caption s1-but customin skewtoright imed-sl1"
                        ...
                        <a href="signup.jsp">
                        <select id="Areavise">
                        	<option value="0">Find your doctor Area vise</option>
                        	<option value="1">Ashram Road</option>
                        	<option value="2">Ambawadi</option>
                        	<option value="3">Asarwa</option>
                        	<option value="4">Astodia</option>
                        	<option value="5">Bopal</option>
                        	<option value="6">Bapu Nagar</option>
                        	<option value="7">C.G. Road</option>
                        	<option value="8">Dani Limbada</option>
                        	<option value="9">Dariapur</option>
                        	<option value="10">Ellis Bridge</option>
                        	<option value="11">Ghatlodia</option>
                        	<option value="12">Gulbai Tekra</option>
                        	<option value="13">Gita Mandir Road</option>
                        	<option value="14">Jamalpur</option>
                        	<option value="15">Khokra Mehmedabad</option>
                        	<option value="16">Kankaria</option>
                        	<option value="17">Kalupur</option>
                        	<option value="18">Kadia</option>
                        	<option value="19">Lal Darwaza</option>
                        	<option value="20">Maninagar</option>
                        	<option value="21">Meghani Nagar</option>
                        	<option value="22">Mithakhali Six Roads</option>
                        	<option value="23">Mem Nagar</option>
                        	<option value="24">Navrangpura</option>
                        	<option value="25">Naranpura</option>
                        	<option value="26">Naroda</option>
                        	<option value="27">Narol</option>
                        	<option value="28">Odhav</option>
                        	<option value="29">Prahlad Nagar</option>
                        	<option value="30">Raipur</option>
                        	<option value="31">Ranip</option>
                        	<option value="32">S.G. Road</option>
                        	<option value="33">Saraspur</option>
                        	<option value="34">Satellite Area</option>
                        	<option value="35">Sarangpur Darwaza</option>
                        	<option value="36">Sabarmati</option>
                        	<option value="37">Shahibaug</option>
                        	<option value="38">Shahpur</option>
                        	<option value="39">Sanand</option>
                        	<option value="40">University Area</option>
                        	<option value="41">Vasana</option>
                        	<option value="42">Vadaj</option>
                        ...
                        <select id="Speciality">
                        	...
                        	<option value="1">Audiologist</option>
                        	<option value="2">Allergist</option>
                        	<option value="3">Anesthesiologist</option>
                        	<option value="4">Cardiologist</option>
                        	<option value="5">Dentist</option>
                        	<option value="6">Dermatologist</option>
                        	<option value="7">Endocrinologis</option>
                        	<option value="8">Epidemiologist</option>
                        	<option value="9">Gynecologist</option>
                        	<option value="10">Immunologist</option><option value="1">Audiologist</option>
                        	<option value="11">Infectious Disease Specialist</option>
                        	<option value="12">Internal Medicine Specialist</option>
                        	<option value="13">Medical Geneticist</option>
                        	<option value="14">Microbiologist</option>
                        	<option value="15"> Neonatologist</option>
                        	<option value="16">Neurologist</option>
                        	<option value="17">Neurosurgeon</option>
                        	<option value="18">Obstetrician</option>
                        	<option value="19">Oncologist</option>
                        	<option value="20">Orthopedic Surgeon</option>
                        	<option value="21"> ENT Specialist</option>
                        	<option value="22">Pediatrician</option>
                        	<option value="23">Physiologist</option>
                        	<option value="24">Plastic Surgeon</option>
                        	<option value="25">Podiatrist</option><option value="1">Audiologist</option>
                        	<option value="26">Psychiatrist</option>
                        	<option value="27">Radiologist</option>
                        	<option value="28">Rheumatologist</option>
                        	<option value="29">Surgeon</option>
                        </select>
                        </a>
                        
                        <a href="signup.jsp">Find Doctor
                        </a>
